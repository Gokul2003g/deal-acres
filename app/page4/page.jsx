  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center py-16 gap-16 w-11/12 lg:gap-32">
        <div className="bg-lightBlue flex flex-col items-center justify-center rounded-3xl max-w-md w-10/12 py-8 px-8 md:py-36 my-8">
          ...
          <p className="text-lg sm:text-2xl font-normal">You Can Email Us</p>
          <a
