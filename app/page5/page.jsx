  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <ProgessBar
        ...
        status5={false}
      />
      <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start w-11/12 justify-center py-16 gap-16 lg:gap-32">
        <div className="border-lightBlue border-8 w-11/12 max-w-2xl rounded-2xl p-8">
          ...
          <div className="flex flex-col gap-4 py-4 pb-8">
            <input className="border-4 p-4 sm:py-36 w-full placeholder:text-black border-lightBlue rounded-lg" />
          </div>
          ...
          <div className="flex flex-row flex-wrap">
            <p className="text-xl inline">Covered Parking</p>
            <div>
          ...
          <div className="flex flex-row flex-wrap">
            <p className="text-xl inline">Open Parking</p>
            <div>
          ...
          <div className="flex pb-4 flex-row flex-wrap">
        ...
        <div className="flex flex-col">
          <div className="bg-lightBlue flex flex-col items-center justify-center rounded-3xl max-w-lg md:px-24 md:py-28 py-12 px-8">
            <div className="flex flex-row">
              <span className="text-lg sm:text-2xl pl-4 text-center ">
                Describe your property in brief so the buyer or renter can
                easily get to know how your property is what makes your property
